...
// Map
// ---------------------------------
setTimeout(_modules_map__WEBPACK_IMPORTED_MODULE_2__["initMap"], 3000);

// Menu
// ---------------------------------
Object(_modules_menu__WEBPACK_IMPORTED_MODULE_3__["initMobileMenu"])();
...
var initMap = function initMap() {
  ...
  ymaps.ready(function () {
    ...
    var placemark = new ymaps.Placemark([59.93866382862344, 30.322931431755293], {}, {
...
var initMobileMenu = function initMobileMenu() {
  if (document.documentElement.clientWidth < 768) {
    ...
    document.addEventListener('click', function (e) {
      ...
      var itsToggle = target === toggle;
      var menuIsActive = menu.classList.contains('is-active');
